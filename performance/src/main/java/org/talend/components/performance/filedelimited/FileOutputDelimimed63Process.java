...
public class FileOutputDelimimed63Process {
    
    public static int LINE_TO_GENERATE = 1000000;
    ...
    public void tRowGenerator_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
        ...
        try {
            ...
            if (true) {
                ...
                props_tFileOutputDelimited_2.setValue("fileName", "D:/TOSWorkspace/Performance/out.csv");
                ...
                int nb_max_row_tRowGenerator_2 = LINE_TO_GENERATE;
