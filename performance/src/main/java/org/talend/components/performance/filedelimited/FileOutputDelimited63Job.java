 ...
 * @status 
 */
public class FileOutputDelimited63Job implements TalendJob {
        ...
        public void printStackTrace() {
            ...
            if (!(e instanceof TDieException)) {
                if (e instanceof TalendException) {
                    ...
                    FileOutputDelimited63Job.this.exception = e;
                }
            }
            if (!(e instanceof TalendException)) {
                try {
                    for (java.lang.reflect.Method m : this.getClass()
                        ...
                        if (m.getName().compareTo(currentComponent + "_error") == 0) {
                            m.invoke(FileOutputDelimited63Job.this, new Object[] {
    ...
    public void tRowGenerator_2Process(
        ...
        try {
            ...
            if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
                ...
                props_tFileOutputDelimited_2.setValue("creatDirIfNotExist",
                        true);
                ...
                props_tFileOutputDelimited_2.setValue("fileName",
                ...
                props_tFileOutputDelimited_2.setValue("advancedSeparator",
                        false);
                ...
                props_tFileOutputDelimited_2.main
                        .setValue(
                                "schema",
                ...
                props_tFileOutputDelimited_2.encoding.setValue("encodingType",
                        "CUSTOM");
                props_tFileOutputDelimited_2.encoding.setValue(
                        "customEncoding", "US-ASCII");
                ...
                org.talend.daikon.runtime.RuntimeInfo runtime_info_tFileOutputDelimited_2 = def_tFileOutputDelimited_2
                        .getRuntimeInfo(props_tFileOutputDelimited_2,
                                topology_tFileOutputDelimited_2);
                ...
                org.talend.components.api.component.runtime.SourceOrSink sourceOrSink_tFileOutputDelimited_2 = (org.talend.components.api.component.runtime.SourceOrSink) (Class
                        .forName(runtime_info_tFileOutputDelimited_2
                                .getRuntimeClassName()).newInstance());
                sourceOrSink_tFileOutputDelimited_2.initialize(
                        container_tFileOutputDelimited_2,
                        props_tFileOutputDelimited_2);
                ...
                if (vr_tFileOutputDelimited_2.getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR) {
                    throw new RuntimeException(
                            vr_tFileOutputDelimited_2.getMessage());
                }
                ...
                writeOperation_tFileOutputDelimited_2
                        .initialize(container_tFileOutputDelimited_2);
                ...
                resourceMap.put("writer_tFileOutputDelimited_2",
                        writer_tFileOutputDelimited_2);
                ...
                for (int itRowGenerator_2 = 0; itRowGenerator_2 < nb_max_row_tRowGenerator_2; itRowGenerator_2++) {
                    ...
                    current_tFileOutputDelimited_2.put("Column10",
                            row2.Column10);
                    current_tFileOutputDelimited_2.put("Column11",
                            row2.Column11);
                    current_tFileOutputDelimited_2.put("Column12",
                            row2.Column12);
                    current_tFileOutputDelimited_2.put("Column13",
                            row2.Column13);
                    current_tFileOutputDelimited_2.put("Column14",
                            row2.Column14);
                    current_tFileOutputDelimited_2.put("Column15",
                            row2.Column15);
                    current_tFileOutputDelimited_2.put("Column16",
                            row2.Column16);
                    current_tFileOutputDelimited_2.put("Column17",
                            row2.Column17);
                    current_tFileOutputDelimited_2.put("Column18",
                            row2.Column18);
                    current_tFileOutputDelimited_2.put("Column19",
                            row2.Column19);
                    current_tFileOutputDelimited_2.put("Column20",
                            row2.Column20);
                    current_tFileOutputDelimited_2.put("Column21",
                            row2.Column21);
                    current_tFileOutputDelimited_2.put("Column22",
                            row2.Column22);
                    current_tFileOutputDelimited_2.put("Column23",
                            row2.Column23);
                    current_tFileOutputDelimited_2.put("Column24",
                            row2.Column24);
                    current_tFileOutputDelimited_2.put("Column25",
                            row2.Column25);
                    current_tFileOutputDelimited_2.put("Column26",
                            row2.Column26);
                    current_tFileOutputDelimited_2.put("Column27",
                            row2.Column27);
                    current_tFileOutputDelimited_2.put("Column28",
                            row2.Column28);
                    current_tFileOutputDelimited_2.put("Column29",
                            row2.Column29);
                    current_tFileOutputDelimited_2.put("Column30",
                            row2.Column30);
                    Object data_tFileOutputDelimited_2 = current_tFileOutputDelimited_2
                            .createIndexedRecord();

                    writer_tFileOutputDelimited_2
                            .write(data_tFileOutputDelimited_2);
                ...
                final java.util.Map<String, Object> resultMap_tFileOutputDelimited_2 = writer_tFileOutputDelimited_2
                        ...
                        .finalize(
                                java.util.Arrays
                                        .<org.talend.components.api.component.runtime.Result> asList(resultObject_tFileOutputDelimited_2),
                                container_tFileOutputDelimited_2);
                if (resultMap_tFileOutputDelimited_2 != null) {
                    for (java.util.Map.Entry<String, Object> entry_tFileOutputDelimited_2 : resultMap_tFileOutputDelimited_2
                        ...
                        case org.talend.components.api.component.ComponentDefinition.RETURN_ERROR_MESSAGE:
                            container_tFileOutputDelimited_2.setComponentData(
                                    "tFileOutputDelimited_2", "ERROR_MESSAGE",
                                    entry_tFileOutputDelimited_2.getValue());
                            break;
                        case org.talend.components.api.component.ComponentDefinition.RETURN_TOTAL_RECORD_COUNT:
                            container_tFileOutputDelimited_2.setComponentData(
                                    "tFileOutputDelimited_2", "NB_LINE",
                                    entry_tFileOutputDelimited_2.getValue());
                            break;
                        case org.talend.components.api.component.ComponentDefinition.RETURN_SUCCESS_RECORD_COUNT:
                            container_tFileOutputDelimited_2.setComponentData(
                                    "tFileOutputDelimited_2", "NB_SUCCESS",
                                    entry_tFileOutputDelimited_2.getValue());
                            break;
                        case org.talend.components.api.component.ComponentDefinition.RETURN_REJECT_RECORD_COUNT:
                            container_tFileOutputDelimited_2.setComponentData(
                                    "tFileOutputDelimited_2", "NB_REJECT",
                                    entry_tFileOutputDelimited_2.getValue());
                            break;
                        default:
                            ...
                            for (int i_tFileOutputDelimited_2 = 0; i_tFileOutputDelimited_2 < entry_tFileOutputDelimited_2
                                ...
                                char ch_tFileOutputDelimited_2 = entry_tFileOutputDelimited_2
                                        .getKey().charAt(
                                                i_tFileOutputDelimited_2);
                                if (Character
                                        .isUpperCase(ch_tFileOutputDelimited_2)
                                        && i_tFileOutputDelimited_2 > 0) {
                                    studio_key_tFileOutputDelimited_2
                                            .append('_');
                                }
                                studio_key_tFileOutputDelimited_2
                                        .append(ch_tFileOutputDelimited_2);
                            }
                            container_tFileOutputDelimited_2.setComponentData(
                    ...
                    if (resourceMap.get("writer_tFileOutputDelimited_2") != null) {
                        try {
                            ((org.talend.components.api.component.runtime.Writer) resourceMap
                                    .get("writer_tFileOutputDelimited_2"))
                                    .close();
                            ...
                            System.err
                                    .println(errorMessage_tFileOutputDelimited_2);
                        }
                    }
                }
    ...
    public static void main(String[] args) {
        final FileOutputDelimited63Job fileOutputDelimitedClass = new FileOutputDelimited63Job();
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = FileOutputDelimited63Job.class
...
/************************************************************************************************
 * 64182 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:15:15 PM EEST
 ************************************************************************************************/
