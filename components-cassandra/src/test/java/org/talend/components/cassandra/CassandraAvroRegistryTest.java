...
import static org.talend.components.cassandra.CassandraAvroRegistry.PROP_CASSANDRA_DATATYPE_NAME;
 ...
 */
public class CassandraAvroRegistryTest {
    ...
    private Schema assertSimpleNullable(Schema s, DataType.Name name, Schema.Type schemaType) {
        ...
        s = unwrapIfNullable(s);
        assertThat(s.getObjectProps().entrySet(), hasSize(greaterThanOrEqualTo(1)));
        assertThat(s.getObjectProps(), hasKey(PROP_CASSANDRA_DATATYPE_NAME));
        assertThat(s.getProp(PROP_CASSANDRA_DATATYPE_NAME), is(name.name()));
    ...
    public void assertUdtItem(Schema s) {
        ...
        assertThat(s.getObjectProps().size(), is(2));
        ...
        assertThat(s.getProp(CassandraAvroRegistry.PROP_CASSANDRA_DATATYPE_NAME), is(DataType.Name.UDT.name()));
