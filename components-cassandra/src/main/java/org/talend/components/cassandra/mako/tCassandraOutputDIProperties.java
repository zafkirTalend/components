...
public class tCassandraOutputDIProperties extends CassandraMetadataProperties {
    ...
    public Property actionOnKeyspace = PropertyFactory.newEnum("actionOnKeyspace", "NONE", "DROP_CREATE", "CREATE",
            "CREATE_IF_NOT_EXISTS", "DROP_IF_EXISTS_AND_CREATE");

    public Property actionOnColumnFamily = PropertyFactory.newEnum("actionOnColumnFamily", "NONE", "DROP_CREATE", "CREATE",
            "CREATE_IF_NOT_EXISTS", "DROP_IF_EXISTS_AND_CREATE", "TRUNCATE");
