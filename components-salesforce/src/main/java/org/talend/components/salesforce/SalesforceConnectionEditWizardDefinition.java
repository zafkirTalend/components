...
@Component(name = Constants.COMPONENT_WIZARD_BEAN_PREFIX + SalesforceConnectionEditWizardDefinition.COMPONENT_WIZARD_NAME, provide = ComponentWizardDefinition.class)
