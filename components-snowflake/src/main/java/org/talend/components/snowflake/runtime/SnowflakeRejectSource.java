...
public class SnowflakeRejectSource extends SnowflakeSourceOrSink implements BoundedSource {

    public SnowflakeRejectSource() {
    }
    ...
    public BoundedReader createReader(RuntimeContainer container) {
        if (properties instanceof TSnowflakeOutputRejectProperties) {
            TSnowflakeOutputRejectProperties sfInProps = (TSnowflakeOutputRejectProperties) properties;
            try {
                return new SnowflakeRejectReader(container, this, sfInProps);
            } catch (IOException e) {
