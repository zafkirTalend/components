...
public class FileInputDefinition extends AbstractComponentDefinition {
    ...
    public List<String> getSupportedProducts() {
        return Arrays.asList(new String[] { SupportedProduct.DI, SupportedProduct.MAP_REDUCE, SupportedProduct.SPARK,
                SupportedProduct.SPARKSTREAMING, SupportedProduct.STORM });
    }
    ...
    // new Class[] { FileInputProperties.class });
    // }
}
