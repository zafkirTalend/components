...
public class PubSubDatasetProperties extends PropertiesImpl implements DatasetProperties<PubSubDatastoreProperties> {
    ...
    public PubSubAttributesTableProperties attributes = new PubSubAttributesTableProperties("attributes");
    ...
    public void setupLayout() {
        ...
        mainForm.addRow(Widget.widget(attributes).setWidgetType(Widget.TABLE_WIDGET_TYPE));
