...
public class SalesforceConnectionPropertiesTest {
    ...
    public void testValidateTestConnection() throws Exception {
        ...
        when(runtimeSourceOrSink.validate(any(RuntimeContainer.class))).thenReturn(
                new ValidationResultMutable().setStatus(ValidationResult.Result.ERROR).setMessage("Error"));
