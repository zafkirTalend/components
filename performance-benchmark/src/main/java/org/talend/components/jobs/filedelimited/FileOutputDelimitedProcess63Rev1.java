...
import static org.talend.components.jobs.filedelimited.FileOutputDelimitedSettings.FILE_NAME;
import static org.talend.components.jobs.filedelimited.FileOutputDelimitedSettings.ROW_GENERATOR_ROWS;
...
public class FileOutputDelimitedProcess63Rev1 {
    
    public static void main(String[] args) throws Exception {
        FileOutputDelimitedProcess63Rev1 fad = new FileOutputDelimitedProcess63Rev1();
        fad.tRowGenerator_2Process(new HashMap<String, Object>());
    }
                ...
                try {
                    for (java.lang.reflect.Method m : this.getClass()
                        ...
                        if (m.getName().compareTo(currentComponent + "_error") == 0) {
                            m.invoke(FileOutputDelimitedProcess63Rev1.this, new Object[] {
