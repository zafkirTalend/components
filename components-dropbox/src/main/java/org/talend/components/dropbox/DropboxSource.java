...
/**
 * The DropboxSource provides the mechanism to supply data to other components
 * at run-time.
 *
 ...
 *
 * <ul>
 * <li>the simplified logic for reading is found in the {@link DropboxReader},
 * and</li>
 * </ul>
 */
public class DropboxSource implements BoundedSource {
    ...
    public void initialize(RuntimeContainer container, ComponentProperties properties) {
        this.properties = (DropboxProperties) properties;
    ...
    public BoundedReader createReader(RuntimeContainer container) {
        return new DropboxReader(container, this, this.properties.filename.getStringValue());
    }
